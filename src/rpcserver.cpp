...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Pandemia server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Pandemia server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pandemia features */
        {"pandemia", "masternode", &masternode, true, true, false},
        {"pandemia", "listmasternodes", &listmasternodes, true, true, false},
        {"pandemia", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pandemia", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pandemia", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pandemia", "masternodedebug", &masternodedebug, true, true, false},
        {"pandemia", "startmasternode", &startmasternode, true, true, false},
        {"pandemia", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pandemia", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pandemia", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pandemia", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pandemia", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pandemia", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pandemia", "mnbudget", &mnbudget, true, true, false},
        {"pandemia", "preparebudget", &preparebudget, true, true, false},
        {"pandemia", "submitbudget", &submitbudget, true, true, false},
        {"pandemia", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pandemia", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pandemia", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pandemia", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pandemia", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pandemia", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pandemia", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pandemia", "checkbudgets", &checkbudgets, true, true, false},
        {"pandemia", "mnsync", &mnsync, true, true, false},
        {"pandemia", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> pandemia-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:48762/\n";
}
