...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pandemia Core"),
     ...
     * override -datadir in the pandemia.conf file in the default data directory
     * (to be consistent with pandemiad behavior)
     */
    if (dataDir != getDefaultDataDirectory())
