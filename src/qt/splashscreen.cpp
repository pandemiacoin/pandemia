...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Pandemia Core");
    ...
    QString copyrightTextPNDM = QChar(0xA9) + QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Pandemia Core developers"));
    ...
    pixPaint.setPen(QColor(157, 0, 0));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextPNDM);
