                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pandemia Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PNDM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pandemia: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pandemia Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pandemia Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pandemia"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PNDM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PNDM addresses"));
    ...
    openAction->setStatusTip(tr("Open a pandemia: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pandemia Core help message to get a list with possible Pandemia command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Pandemia Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pandemia network", "", count));
}
...
{
    QString strTitle = tr("Pandemia Core"); // default title
