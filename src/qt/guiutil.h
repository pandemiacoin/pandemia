...
/** Utility functions used by the Pandemia Qt UI.
 */
namespace GUIUtil
{
...
// Render PNDM addresses in monospace font
...
// Parse "pandemia:" URI into recipient object, return true on successful parsing
