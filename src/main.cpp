...
#if defined(NDEBUG)
#error "Pandemia cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in upndm) are considered zero fee (for relaying and mining)
...
{
    RenameThread("pandemia-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // PNDM: We use certain sporks during IBD, so check to see if they are
