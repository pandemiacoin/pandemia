...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pandemia Core pandemia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pandemia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pandemia transaction") + "\n" +
                               "  pandemia-tx [options] -create [commands]   " + _("Create hex-encoded pandemia transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pandemia transaction
