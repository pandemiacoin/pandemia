...
RESOURCES += src/qt/pandemia.qrc src/qt/pandemia_locale.qrc

TRANSLATIONS += src/qt/locale/pandemia_bg.ts \
                src/qt/locale/pandemia_de.ts \
                src/qt/locale/pandemia_en.ts \
                src/qt/locale/pandemia_es.ts \
                src/qt/locale/pandemia_fi.ts \
                src/qt/locale/pandemia_fr.ts \
                src/qt/locale/pandemia_it.ts \
                src/qt/locale/pandemia_ja.ts \
                src/qt/locale/pandemia_pl.ts \
                src/qt/locale/pandemia_pt.ts \
                src/qt/locale/pandemia_ru.ts \
                src/qt/locale/pandemia_sk.ts \
                src/qt/locale/pandemia_sv.ts \
                src/qt/locale/pandemia_vi.ts \
                src/qt/locale/pandemia_zh_CN.ts \
                src/qt/locale/pandemia_zh_TW.ts
