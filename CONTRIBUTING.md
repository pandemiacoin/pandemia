Contributing to Pandemia Core
==================================

The Pandemia Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Pandemia Core project, and is not to be
confused with overall Pandemia Network Protocol consensus changes.

Whether a pull request is merged into Pandemia Core rests with the project merge
...
Patches that change Pandemia consensus rules are considerably more involved than
...
Where a patch set proposes to change the Pandemia consensus, it must have been
...
The project leader is the release manager for each Pandemia Core release.
