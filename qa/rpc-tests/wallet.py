...
#   c) node1 mines 32 blocks, so now node 0 has 500000PNDM, node 1 has 4250PNDM, node2 has none.
#   d) node0 sends 601 PNDM to node2, in two transactions (301 PNDM, then 300 PNDM).
