...
This mechanism has been integrated into Bitcore-Node-Pandemia which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pandemia/insight-api-pandemia#web-socket-api](https://github.com/pandemia/insight-api-pandemia#web-socket-api)
* API: [https://github.com/pandemia/insight-api-pandemia#swifttx-transactions](https://github.com/pandemia/insight-api-pandemia#swifttx-transactions)
...
By default, the Pandemia Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pandemia Core daemon:
