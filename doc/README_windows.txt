...
Intro
-----
Pandemia (PNDM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Pandemia utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run pandemia-qt.exe.

Pandemia Core is the original Pandemia client and it builds the backbone of the network.
However, it downloads and stores the entire history of Pandemia transactions;
