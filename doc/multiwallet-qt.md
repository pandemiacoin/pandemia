...
In order to support loading of multiple wallets in pandemia-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pandemia.cpp.
...
Changes to pandemia.cpp
----------------------
pandemia.cpp is the entry point into pandemia-qt, and as such, will require some minor modifications to provide hooks for
